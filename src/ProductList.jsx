...
function ProductList({ onHomeClick }) {
  ...
  // Menghitung total jumlah item yang ada di keranjang untuk badge ikon keranjang
  ...
  // Fungsi saat tombol "Add to Cart" diklik
  ...
  return (
    <div>
          ...
          <div>
            <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
              <h1 className="cart" style={{ display: 'flex', alignItems: 'center' }}>
                ...
                {/* Badge Angka Jumlah Produk di Keranjang */}
                <span className="cart_quantity_count" style={{ marginLeft: '5px', fontSize: '24px' }}>{totalQuantity}</span>
              </h1>
            </a>
          </div>
        </div>
      ...
      {/* Tampilan Utama Produk atau Keranjang */}
      {!showCart ? (
        <div className="product-grid">
          {plantsArray.map((categoryObj, index) => (
            <div key={index}>
              <h1 style={{ textAlign: 'center', margin: '20px 0' }}>{categoryObj.category}</h1>
                ...
                {categoryObj.plants.map((plant, plantIndex) => {
                  ...
                  return (
                    <div className="product-card" key={plantIndex} style={{ border: '1px solid #ccc', borderRadius: '8px', padding: '15px', width: '250px', textAlign: 'center' }}>
                      ...
                      <div className="product-price" style={{ color: 'green', fontWeight: 'bold', margin: '10px 0' }}>{plant.cost}</div>
                      <button
